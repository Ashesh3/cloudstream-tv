...
export function Login({ onLogin }: { onLogin(passphrase: string): Promise<void> }) {
  ...
  const submit = async (event: FormEvent) => {
    ...
    catch (cause) { setError(cause instanceof AdminApiError ? cause.message : "Sign in failed."); }
